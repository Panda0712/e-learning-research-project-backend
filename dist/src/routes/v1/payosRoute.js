 ...
 */
Router.route("/create-payment").post(payosValidation.createPaymentLink, payosController.createPaymentLink);
/**
 ...
 */
Router.route("/check-status/:orderId").get(payosValidation.checkPaymentStatus, payosController.checkPaymentStatus);
/**
 * Cancel Payment
 * PUT /api/payos/cancel/:orderId
 * Hủy link thanh toán nếu người dùng không muốn thanh toán nữa
 */
Router.route("/cancel/:orderId").put(payosValidation.cancelPayment, payosController.cancelPayment);
export const payosRoute = Router;
//# sourceMappingURL=payosRoute.js.map