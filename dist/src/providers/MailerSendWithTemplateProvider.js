...
const sendEmail = async ({ to, toName, subject, html, templateId, personalizationData, }) => {
    try {
...
export const MailerSendWithTemplateProvider = { sendEmail };
//# sourceMappingURL=MailerSendWithTemplateProvider.js.map