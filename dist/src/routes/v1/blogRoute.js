...
Router.route("/thumbnail").post(multerUploadMiddleware.uploadImage.single("images"), blogController.uploadBlogThumbnail);
// BLOG COMMENT ROUTE
Router.route("/blogComments").post(blogValidation.createComment, blogController.createComment);
