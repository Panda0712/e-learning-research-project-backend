...
export declare const lecturerPayoutController: {
    ...
    getAllLecturerPayouts: (req: Request, res: Response, next: NextFunction) => Promise<void>;
...
//# sourceMappingURL=lecturerPayoutController.d.ts.map