...
export type GetBlogCommentAggregateType<T extends BlogCommentAggregateArgs> = {
    [P in keyof T & keyof AggregateBlogComment]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateBlogComment[P]> : Prisma.GetScalarType<T[P], AggregateBlogComment[P]>;
};
...
type GetBlogCommentGroupByPayload<T extends BlogCommentGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<BlogCommentGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof BlogCommentGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], BlogCommentGroupByOutputType[P]> : Prisma.GetScalarType<T[P], BlogCommentGroupByOutputType[P]>;
}>>;
export type BlogCommentWhereInput = {
    ...
    id?: Prisma.IntFilter<"BlogComment"> | number;
...
export type BlogCommentScalarWhereWithAggregatesInput = {
    ...
    id?: Prisma.IntWithAggregatesFilter<"BlogComment"> | number;
...
export type BlogCommentCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<BlogCommentFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BlogCommentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['BlogComment'];
        meta: {
            name: 'BlogComment';
        };
    };
     ...
     * })
    **/
    count<T extends BlogCommentCountArgs>(args?: Prisma.Subset<T, BlogCommentCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], BlogCommentCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends BlogCommentGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, BlogCommentGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBlogCommentGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface BlogCommentFieldRefs {
    readonly id: Prisma.FieldRef<"BlogComment", 'Int'>;
