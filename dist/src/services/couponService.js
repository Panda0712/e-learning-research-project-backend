...
const createCouponCategory = async (data) => {
    try {
        ...
        if (category) {
            throw new ApiError(StatusCodes.CONFLICT, "Coupon category already exists!");
        }
        // create category
...
const getCouponCategoryById = async (id) => {
    try {
        const category = await prisma.couponCategory.findUnique({
            where: {
                id,
...
const updateCouponCategory = async (id, data) => {
    try {
...
const deleteCouponCategory = async (id) => {
    try {
        // check category existence
        const category = await prisma.couponCategory.findUnique({
            where: { id, isDestroyed: false },
...
const getAllCoupons = async (filters) => {
    try {
        ...
        const whereCondition = { isDestroyed: false };
    ...
    try {
        ...
        const updated = await prisma.coupon.update({
            ...
            data: {
                ...
                customerGroup: data.customerGroup !== undefined
                    ? data.customerGroup
                ...
                usesPerCustomer: data.usesPerCustomer !== undefined
                ...
                startingDate: data.startingDate !== undefined
                    ? data.startingDate
                    : coupon.startingDate,
                ...
                isUnlimited: data.isUnlimited !== undefined
                    ? data.isUnlimited
                    : coupon.isUnlimited,
                updatedAt: new Date(),
            },
