...
Router.route("/lecturers").get(userValidation.getPublicLecturers, userController.getPublicLecturers);
Router.route("/lecturers/:id").get(userValidation.getPublicLecturerById, userController.getPublicLecturerDetail);
Router.route("/register-lecturer").post(authMiddleware.isAuthorized, userValidation.registerLecturer, userController.registerLecturerProfile);
...
Router.route("/update").put(authMiddleware.isAuthorized, userValidation.update, userController.updateProfile);
...
Router.route("/avatar").post(authMiddleware.isAuthorized, multerUploadMiddleware.uploadImage.single("images"), userController.uploadAvatar);
Router.route("/lecturer-file").post(multerUploadMiddleware.uploadDoc.single("files"), userController.uploadLecturerFile);
