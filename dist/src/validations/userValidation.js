...
import { EMAIL_RULE, EMAIL_RULE_MESSAGE, PASSWORD_RULE, PASSWORD_RULE_MESSAGE, PHONE_RULE, PHONE_RULE_MESSAGE, } from "@/utils/validators.js";
...
export const registerLecturer = async (req, res, next) => {
    const correctCondition = Joi.object({
        ...
        highestDegree: Joi.string()
            .required()
            .valid(DEGREE_OPTIONS.BACHELOR, DEGREE_OPTIONS.DOCTORAL, DEGREE_OPTIONS.MASTER, DEGREE_OPTIONS.ASSOCIATE_PROFESSOR, DEGREE_OPTIONS.EMERITUS_PROFESSOR, DEGREE_OPTIONS.PHD, DEGREE_OPTIONS.PROFESSOR),
...
export const getPublicLecturers = async (req, res, next) => {
    const correctCondition = Joi.object({
...
export const getPublicLecturerById = async (req, res, next) => {
    const correctCondition = Joi.object({
