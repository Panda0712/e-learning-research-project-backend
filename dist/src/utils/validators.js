...
export const PASSWORD_RULE_MESSAGE = "Password has to be at least 1 character, 1 number and 8 characters min.";
...
export const PHONE_RULE_MESSAGE = "Invalid phone number! Please enter a valid phone number!";
