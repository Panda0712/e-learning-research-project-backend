...
Router.route("/").post(questionValidation.createQuestion, questionController.createQuestion);
...
Router.route("/by-quiz/:quizId").get(questionValidation.getAllQuestionsByQuizId, questionController.getAllQuestionsByQuizId);
