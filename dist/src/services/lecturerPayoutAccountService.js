...
const getLecturerPayoutAccountById = async (id) => {
    try {
...
const getDefaultPayoutAccount = async (lecturerId) => {
    try {
        ...
        if (!payoutAccount) {
            throw new ApiError(StatusCodes.NOT_FOUND, "No default payout account found!");
        }
        return payoutAccount;
    }
    catch (error) {
...
const updateLecturerPayoutAccount = async (id, data) => {
    try {
        const payoutAccount = await prisma.lecturerPayoutAccount.findUnique({
            where: { id, isDestroyed: false },
        });
...
const setDefaultPayoutAccount = async (id, lecturerId) => {
    try {
        const payoutAccount = await prisma.lecturerPayoutAccount.findUnique({
            where: { id, isDestroyed: false },
        });
...
const deleteLecturerPayoutAccount = async (id) => {
    try {
        const payoutAccount = await prisma.lecturerPayoutAccount.findUnique({
            where: { id, isDestroyed: false },
        });
...
//# sourceMappingURL=lecturerPayoutAccountService.js.map